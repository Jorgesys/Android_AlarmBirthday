        ...
        try{
            ...
            if (cursor.moveToFirst()) {
                while (!cursor.isAfterLast()) {
                    ...
                    Log.i(TAG, "fecha alarma: " + cursor.getString(2) );
                    setAlarm(Integer.parseInt(cursor.getString(0)), String.valueOf(cursor.getString(1)), String.valueOf(cursor.getString(2)));
                    cursor.moveToNext();
                }
            }
            cursor.close();
